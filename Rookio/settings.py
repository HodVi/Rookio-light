"""
Django settings for Rookio project.
...
WSGI_APPLICATION = 'Rookio.wsgi.application'
...
# my note - for handling media files
# my note - public URL of uploaded files
MEDIA_URL = '/media/'
# my note - where the uploaded files are actually stored in system
